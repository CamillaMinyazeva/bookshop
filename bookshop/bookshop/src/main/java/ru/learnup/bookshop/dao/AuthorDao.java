...
public class AuthorDao {
    ...
    private final NamedParameterJdbcTemplate pattern;

    public AuthorDao(NamedParameterJdbcTemplate pattern) {
        this.pattern = pattern;
    }

    public Author findById(long id){
        return pattern.query(FIND_BY_ID,
    ...
    public void save(Author author){
        pattern.update(SAVE, new MapSqlParameterSource()
